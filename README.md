...
redis.processing-timeout  | REDIS_PROCESSING_TIMEOUT        | PT3M | Time after which an event that did not complete processing will be re-delivered by Redis. Formatted as ISO8601 duration.
